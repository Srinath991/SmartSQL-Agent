        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4 max-w-md">
              Transform natural language into SQL queries instantly. Built for developers who want to query their data without writing complex SQL.
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Powered by Supabase,fastAPI & Next.js
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link href="https://github.com/Srinath991" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
              ...
              <Link href="https://www.linkedin.com/in/ai-engineer-ml-engineer-nlp-engineer/" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
